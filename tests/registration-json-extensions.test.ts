...
describe('Registration JSON extensions', () => {
  ...
  it('[R10,R11] transform parses extension fields and defaults entityType', () => {
    ...
    const rfDefault = (sdk as any)._transformRegistrationFile(rawDefault);
    ...
    const rfExtended = (sdk as any)._transformRegistrationFile(rawExtended);
  ...
  it('[R10] provenance roundtrip remains stable', () => {
    ...
    const transformed = (sdk as any)._transformRegistrationFile(built);
